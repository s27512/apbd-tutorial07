...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job.Equals("Frontend programmer"))
        ...
        {
            IEnumerable<object> result = Emps.Select(e => new {Surname = e.Ename, Job = e.Job});
            return result;
        }
        ...
        public static IEnumerable<object> Task6()
        {
            IEnumerable<object> result = from emp in Emps
                ...
                select new
                {
                    Result = emp.Ename + " " + emp.Job + " " + dept.Dname
                };
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result =
                from dept in Depts
                join emp in Emps on dept.Deptno equals emp.Deptno into g
